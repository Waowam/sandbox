			...
			<div class="bs-example">
				<div class="alert alert-dismissable alert-warning">
					...
					<p>
						...
						libero, a pharetra augue. Praesent commodo cursus magna, <a
							href="#" class="alert-link">vel scelerisque nisl consectetur
							et</a>.
					</p>
				</div>
			</div>
			...
			<div class="bs-example">
				<div class="list-group">
					<a href="#" class="list-group-item active"> Cras justo odio </a> <a
						...
						href="#" class="list-group-item">Morbi leo risus </a>
				</div>
			</div>
		</div>
		<div class="col-lg-4">
